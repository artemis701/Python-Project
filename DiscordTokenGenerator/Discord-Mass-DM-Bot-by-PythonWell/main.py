    ...
    def __init__(self):
        ...
        try:
            with open("data/config.json", "r") as file:
                ...
                self.discord_hcaptcha_id = "4c672325-0701-42b2-88c3-78380bfxb560"
                self.discord_captcha_referer = "https://discord.com/dashboard"
                not_counter = 0
...
with open('config.json') as f:
    ...
    def nonce(self):
        ...
        return str((int(unixts) * 1000 - 1420070400000) * 4194300)
        ...
        if json_token_content["dcfduid"] == "none":
            async with ClientSession() as client:
                ...
                async with client.get("https://discordapp.com/api/v9/experiments") as finger:
                    ...
                    fingerprint = jsonn["fingerprint_session"]
    ...
    async def submit_cap_key(self, proxy):
        ...
        headers = {"User-Agent": "Mozilla/5.1", "Content-Type": "application/json"}
    ...
    async def start(self, first_start):
        ...
        async def check_tokens():
            async with TaskPool(1_500) as pool:
                for token in self.tokens:
                    if len(self.tokens) != 0:
                        if self.use_proxies:
        ...
        async def scrape_users():
            ...
            if len(self.tokens) == 0 else: self.stop()
            return "success"
        ...
        looping = True
        while looping:
            logging.info('Sleeping 40 seconds')
